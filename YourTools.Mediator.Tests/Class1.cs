...
using YourTools.Mediator;
using System.Reflection;
using Application.Features.Pings;
using Application.Features.Products;

namespace YourTools.Mediator.Tests;
...
public class Class1
{
    ...
    public async Task Test_All_Application_Handlers_Dynamically()
    {
        ...
        services.AddTransient<IMediator, YourTools.Mediator.MediatorImplementation>();
